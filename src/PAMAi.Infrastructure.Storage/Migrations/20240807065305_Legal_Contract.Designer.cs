...
namespace PAMAi.Infrastructure.Storage.Migrations
{
    ...
    [Migration("20240807065305_Legal_Contract")]
    partial class Legal_Contract
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PAMAi.Domain.Entities.LegalContract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LegalContract", "Legal terms and conditions of the PAMAi application.");
                });
            ...
            modelBuilder.Entity("PAMAi.Domain.Entities.UserLegalContractConsent", b =>
                {
                    b.Property<Guid>("UserProfileId")
                        .HasColumnType("char(36)");

                    b.Property<int>("LegalContractId")
                        .HasColumnType("int");

                    b.Property<DateTimeOffset?>("AcceptedDateUtc")
                        .HasColumnType("datetime(6)");

                    b.HasKey("UserProfileId", "LegalContractId");

                    b.HasIndex("AcceptedDateUtc");

                    b.HasIndex("LegalContractId");

                    b.ToTable("UserLegalContractConsent", (string)null);
                });
            ...
            modelBuilder.Entity("PAMAi.Domain.Entities.UserLegalContractConsent", b =>
                {
                    b.HasOne("PAMAi.Domain.Entities.LegalContract", "LegalContract")
                        .WithMany("UserLegalContractConsents")
                        .HasForeignKey("LegalContractId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PAMAi.Domain.Entities.UserProfile", "UserProfile")
                        .WithMany("LegalTermsConsents")
                        .HasForeignKey("UserProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LegalContract");
            ...
            modelBuilder.Entity("PAMAi.Domain.Entities.LegalContract", b =>
                {
                    b.Navigation("UserLegalContractConsents");
                });

            modelBuilder.Entity("PAMAi.Domain.Entities.UserProfile", b =>
                {
                    b.Navigation("LegalTermsConsents");
                });
